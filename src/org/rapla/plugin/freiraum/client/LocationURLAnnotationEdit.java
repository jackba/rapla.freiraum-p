...
public class LocationURLAnnotationEdit extends RaplaGUIComponent implements AnnotationEditExtension {
    protected String annotationName = TerminalConstants.LOCATION_URL_FORMAT_ANNOTATION;
    protected String DEFAULT_VALUE = new String();
    protected String fieldName = "location.url";
    
    public LocationURLAnnotationEdit(RaplaContext context) {
        super(context);
    ...
    public EditField createEditField(Annotatable annotatable) {
        ...
        if ( classificationType == null || !(classificationType.equals(DynamicTypeAnnotations.VALUE_CLASSIFICATION_TYPE_RESOURCE)))
        {
            return null;
        }
